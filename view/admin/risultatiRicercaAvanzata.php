<ul>
    <li><h3>Categoria selezionata</h3>
        ...
        <ul class="lista_visiva">
        <?php
        echo '<li><a href="' . 'admin?cmd=ricerca_avanzata' . $parametriPost . '&amp;ric_limiteInferiore=' . $ric_limiteInferiore . '&amp;ric_limiteSuperiore=' . $ric_limiteSuperiore . '&amp;ric_cursore=0' . '">Indietro</a></li>';
